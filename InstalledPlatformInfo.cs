...
namespace UnrealBuildTool
{
	...
	public class InstalledPlatformInfo
	{
		...
		public static bool IsValidPlatform(UnrealTargetPlatform Platform, EProjectType ProjectType = EProjectType.Any)
		{
			...
			if (Platform == UnrealTargetPlatform.HTML5 && ProjectType == EProjectType.Any && BuildHostPlatform.Current.Platform == UnrealTargetPlatform.Win64 && UnrealBuildTool.IsEngineInstalled())
			{
				return true;
			}
